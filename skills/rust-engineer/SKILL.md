---
name: rust-engineer
description: "Пишет идиоматичный Rust код с memory safety и zero-cost абстракциями. Используй для ownership patterns, lifetimes, trait hierarchies, async/await с tokio."
license: MIT
metadata:
