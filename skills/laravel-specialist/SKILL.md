...
description: "Создаёт Laravel 10+ приложения, Eloquent модели, Sanctum аутентификацию, Horizon очереди. Используй для RESTful API, Livewire компонентов, Pest/PHPUnit тестов."
license: MIT
metadata:
