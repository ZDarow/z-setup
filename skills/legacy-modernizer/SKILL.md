...
description: "Проектирует инкрементальные стратегии миграции, определяет границы сервисов, создаёт dependency maps и roadmaps. Используй для strangler fig pattern, декомпозиции монолитов, апгрейда фреймворков, снижения технического долга."
license: MIT
metadata:
