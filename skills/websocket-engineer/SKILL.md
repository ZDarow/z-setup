...
description: "Создаёт real-time системы с WebSockets и Socket.IO. Используй для bidirectional messaging, горизонтального масштабирования с Redis, presence tracking, room management."
license: MIT
metadata:
