...
description: "Пишет E2E тесты с Playwright, настраивает инфраструктуру тестирования, отлаживает нестабильные браузерные тесты. Используй для test scripts, page objects, fixtures, reporters, CI интеграции, API mocking."
license: MIT
metadata:
