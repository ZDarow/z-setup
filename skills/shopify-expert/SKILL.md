---
name: shopify-expert
description: "Создаёт Shopify темы (.liquid), разрабатывает кастомные приложения, реализует Storefront API. Используй для Liquid templating, Hydrogen storefront, checkout extensions."
license: MIT
metadata:
