---
name: react-expert
description: "Создаёт React 18+ компоненты, Next.js App Router, серверные компоненты. Реализует хуки, миграцию class→functional, управление состоянием. Используй для Server Components, Suspense, performance optimization, React 19 фич."
license: MIT
metadata:
