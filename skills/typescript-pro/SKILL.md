---
name: typescript-pro
description: "Реализует продвинутые системы типов TypeScript, кастомные type guards, utility types, branded types. Настраивает tRPC для сквозной типобезопасности. Используй для generics, conditional/mapped types, monorepo, full-stack type safety."
license: MIT
metadata:
