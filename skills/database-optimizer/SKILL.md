...
description: "Оптимизирует SQL запросы, улучшает производительность PostgreSQL/MySQL. Используй для анализа медленных запросов, EXPLAIN планов, дизайна индексов, реврайта запросов, тюнинга конфигурации."
license: MIT
metadata:
