---
name: pandas-pro
description: "Выполняет операции с pandas DataFrame для анализа данных, манипуляции и трансформации. Используй для data cleaning, агрегации, merging, time series анализа, groupby операций, оптимизации больших датасетов."
license: MIT
metadata:
