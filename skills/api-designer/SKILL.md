---
name: api-designer
description: "Проектирует REST и GraphQL API, создаёт OpenAPI спецификации, планирует архитектуру API. Используй для моделирования ресурсов, стратегий версионирования, пагинации, обработки ошибок."
license: MIT
metadata:
