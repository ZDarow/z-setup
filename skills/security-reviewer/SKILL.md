...
description: "Находит уязвимости безопасности, генерирует отчёты с рейтингом критичности и рекомендациями по исправлению. Используй для аудита безопасности, проверки кода на уязвимости, анализа инфраструктуры. Создаёт отчёты об уязвимостях, приоритетные рекомендации, чек-листы соответствия."
license: MIT
