...
description: "Настраивает fine-tuning LLM, обучает кастомные модели, адаптирует foundation модели для специфичных задач. Используй для LoRA/QLoRA адаптеров, JSONL training датасетов, hyperparameter tuning, RLHF, DPO."
license: MIT
metadata:
