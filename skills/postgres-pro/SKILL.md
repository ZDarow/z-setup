---
name: postgres-pro
description: "Оптимизирует PostgreSQL запросы, настраивает репликацию, реализует продвинутые фичи. Используй для EXPLAIN анализа, JSONB операций, расширения, VACUUM тюнинга, мониторинга."
license: MIT
metadata:
