---
name: flutter-expert
description: "Создаёт кроссплатформенные приложения с Flutter 3+ и Dart. Используй для виджетов, Riverpod/Bloc state management, GoRouter навигации, оптимизации производительности."
license: MIT
metadata:
