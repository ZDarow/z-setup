---
name: the-fool
description: "Играет роль адвоката дьявола — оспаривает идеи, планы, решения через структурированное критическое мышление. Используй для pre-mortem анализа, red teaming, аудита предположений."
license: MIT
metadata:
