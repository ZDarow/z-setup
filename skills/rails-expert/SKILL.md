---
name: rails-expert
description: "Создаёт Rails 7+ приложения с Hotwire, Turbo Frames/Streams, Action Cable. Используй для Active Record оптимизации, Sidekiq фоновых задач, RSpec тестов, real-time фич."
license: MIT
metadata:
