...
description: "Реализует инфраструктуру как код с Terraform для AWS, Azure, GCP. Используй для создания модулей, управления состоянием, миграции бэкендов, multi-environment workflows."
license: MIT
metadata:
