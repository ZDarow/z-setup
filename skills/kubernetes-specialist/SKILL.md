...
description: "Разворачивает Kubernetes workloads, создаёт deployment манифесты, настраивает pod security, service accounts, network isolation. Используй для Helm charts, RBAC, NetworkPolicies, GitOps."
license: MIT
metadata:
