...
description: "Реализует аутентификацию/авторизацию, защищает пользовательский ввод, предотвращает OWASP Top 10 уязвимости. Используй для bcrypt/argon2 хеширования, параметризованных SQL запросов, CORS/CSP заголовков, JWT токенов."
license: MIT
metadata:
