...
description: "Проектирует высокоуровневую архитектуру систем, ревьюит существующие дизайны, помогает принимать архитектурные решения. Создаёт диаграммы, ADR, оценивает trade-off, планирует масштабируемость."
license: MIT
metadata:
