...
description: "Генерирует Angular 17+ standalone компоненты, настраивает routing с lazy loading и guards. Используй для NgRx state management, RxJS patterns, оптимизации bundle."
license: MIT
metadata:
