---
name: python-pro
description: "Пишет код на Python 3.11+ с типизацией, асинхронностью, обработкой ошибок. Настраивает mypy в strict mode, пишет pytest тесты, валидирует код через black и ruff. Используй для type hints, async/await, dataclasses, dependency injection, логирования."
license: MIT
metadata:
