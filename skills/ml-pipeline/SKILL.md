---
name: ml-pipeline
description: "Проектирует production-grade ML пайплайны: настраивает experiment tracking с MLflow/W&B, создаёт Kubeflow/Airflow DAGs. Используй для feature store, model registry, автоматизации ретрейнинга, MLOps."
license: MIT
metadata:
