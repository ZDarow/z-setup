---
name: java-architect
description: "Создаёт enterprise Java приложения с Spring Boot 3.x, микросервисами, reactive programming. Используй для WebFlux, JPA оптимизации, Spring Security, OAuth2/JWT."
license: MIT
metadata:
