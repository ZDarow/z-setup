---
name: wordpress-pro
description: "Разрабатывает WordPress темы и плагины, создаёт Gutenberg блоки, настраивает WooCommerce. Используй для REST API endpoints, security hardening, оптимизации производительности."
license: MIT
metadata:
