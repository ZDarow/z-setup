---
name: sql-pro
description: "Оптимизирует SQL запросы, проектирует схемы баз данных, troubleshoot производительность. Используй для сложных запросов, window functions, CTE, индексных стратегий, EXPLAIN/ANALYZE."
license: MIT
metadata:
