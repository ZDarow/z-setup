...
description: "Проектирует распределённые системы, декомпозирует монолиты, рекомендует паттерны коммуникации. Используй для service boundaries, DDD, saga patterns, event sourcing, CQRS."
license: MIT
metadata:
