...
description: "Создаёт C# приложения с .NET 8+, ASP.NET Core API, Blazor. Используй для REST API, Entity Framework Core, async patterns, MediatR, Blazor компонентов."
license: MIT
metadata:
