...
description: "Строит security-focused full-stack веб-приложения с интегрированными frontend и backend компонентами. Используй для аутентификации, валидации ввода, output encoding, параметризованных запросов на всех уровнях."
license: MIT
metadata:
