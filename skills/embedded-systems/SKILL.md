...
description: "Разрабатывает прошивки для микроконтроллеров, реализует RTOS приложения, оптимизирует энергопотребление. Используй для STM32, ESP32, FreeRTOS, bare-metal."
license: MIT
metadata:
