---
name: mcp-developer
description: "Создаёт MCP серверы и клиенты для интеграции AI с внешними инструментами и данными. Используй для tool handlers, resource providers, stdio/HTTP/SSE transport."
license: MIT
metadata:
