...
description: "Создаёт Dockerfile, настраивает CI/CD пайплайны, пишет Kubernetes манифесты, генерирует Terraform/Pulumi шаблоны. Используй для контейнеризации, автоматизации деплоя, GitOps, инфраструктуры как код."
license: MIT
metadata:
