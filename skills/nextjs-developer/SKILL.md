...
description: "Создаёт Next.js 14+ приложения с App Router, серверными компонентами, server actions. Настраивает route handlers, middleware, API routes, streaming SSR, SEO metadata. Используй для Next.js, App Router, RSC, Vercel deployment."
license: MIT
metadata:
