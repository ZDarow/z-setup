---
name: django-expert
description: "Создаёт Django веб-приложения и REST API с Django REST Framework. Используй для моделей, ORM оптимизации, DRF serializers, viewsets, JWT аутентификации."
license: MIT
metadata:
