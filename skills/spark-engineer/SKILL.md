---
name: spark-engineer
description: "Пишет Spark jobs, отлаживает проблемы производительности, настраивает кластеры Apache Spark. Используй для DataFrame трансформаций, оптимизации Spark SQL, RDD пайплайнов, structured streaming."
license: MIT
metadata:
