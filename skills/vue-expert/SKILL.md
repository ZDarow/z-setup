---
name: vue-expert
description: "Создаёт Vue 3 компоненты с Composition API, настраивает Nuxt 3 SSR/SSG, Pinia stores. Используй для composables, Quasar/Capacitor мобильных приложений, PWA."
license: MIT
metadata:
