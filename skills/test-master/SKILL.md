---
name: test-master
description: "Создаёт тестовые файлы, стратегии мокирования, анализирует покрытие кода, проектирует тестовую архитектуру. Используй для написания unit, интеграционных и E2E тестов, создания стратегий тестирования, анализа покрытия, отладки нестабильных тестов."
license: MIT
metadata:
