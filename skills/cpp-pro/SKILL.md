---
name: cpp-pro
description: "Пишет и оптимизирует C++ приложения с C++20/23 фичами, template metaprogramming. Используй для concepts, ranges, coroutines, SIMD оптимизации, memory management."
license: MIT
metadata:
