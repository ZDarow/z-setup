---
name: game-developer
description: "Создаёт игровые системы, реализует Unity/Unreal Engine фичи, оптимизирует производительность. Используй для ECS архитектуры, физики, multiplayer networking, шейдеров."
license: MIT
metadata:
