...
description: "Проектирует облачные архитектуры, создаёт планы миграции, генерирует рекомендации по оптимизации затрат. Используй для Well-Architected Framework, multi-cloud, disaster recovery, serverless."
license: MIT
metadata:
