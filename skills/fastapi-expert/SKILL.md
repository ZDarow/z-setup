---
name: fastapi-expert
description: "Создаёт высокопроизводительные async Python API с FastAPI и Pydantic V2. Используй для REST endpoints, Pydantic моделей, аутентификации, SQLAlchemy async, WebSocket."
license: MIT
metadata:
