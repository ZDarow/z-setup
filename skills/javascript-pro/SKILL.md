---
name: javascript-pro
description: "Пишет и отлаживает JavaScript код с ES2023+ фичами, async/await, ESM модулями, Node.js API. Используй для vanilla JS, Promise-based async flows, оптимизации производительности, Web Workers, Fetch API."
license: MIT
metadata:
