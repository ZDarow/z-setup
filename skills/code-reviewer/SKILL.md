---
name: code-reviewer
description: "Анализирует код для поиска багов, уязвимостей (SQL injection, XSS), запахов кода, N+1 запросов, проблем именования и архитектуры. Создаёт структурированный отчёт с приоритетными рекомендациями. Используй для PR ревью, аудита качества кода, рефакторинга, проверки безопасности."
license: MIT
