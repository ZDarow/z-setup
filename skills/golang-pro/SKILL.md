---
name: golang-pro
description: "Реализует concurrent Go паттерны с goroutines и channels, проектирует микросервисы с gRPC/REST. Используй для goroutines, channels, generics, gRPC, CLI tools, benchmarks."
license: MIT
metadata:
