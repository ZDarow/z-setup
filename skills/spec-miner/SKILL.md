---
name: spec-miner
description: "Специалист по реверс-инжинирингу — извлекает спецификации из существующих кодовых баз. Используй для legacy систем, унаследованных проектов, создания документации из кода, анализа архитектуры."
license: MIT
