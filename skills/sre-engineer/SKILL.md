---
name: sre-engineer
description: "Определяет SLI/SLO, создаёт политики error budget, проектирует процедуры реагирования на инциденты. Используй для управления надёжностью, chaos engineering, снижения toil."
license: MIT
metadata:
