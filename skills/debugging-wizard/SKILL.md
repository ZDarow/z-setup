...
description: "Анализирует сообщения об ошибках, трассировки стека, логи для поиска точек отказа. Применяет систематический подход для изоляции и исправления багов. Используй для расследования ошибок, анализа стектрейсов, поиска корневых причин."
license: MIT
metadata:
