---
name: rag-architect
description: "Проектирует production-grade RAG системы: chunking документов, embeddings, vector stores. Используй для semantic search, hybrid search, reranking, evaluation."
license: MIT
metadata:
