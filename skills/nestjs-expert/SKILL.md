---
name: nestjs-expert
description: "Создаёт NestJS модули, контроллеры, сервисы, DTO, guards, interceptors. Используй для REST/GraphQL API, dependency injection, JWT/Passport аутентификации, TypeORM/Prisma."
license: MIT
metadata:
