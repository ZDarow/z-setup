---
name: atlassian-mcp
description: "Интегрируется с продуктами Atlassian для управления проектами и документацией через MCP протокол. Используй для Jira JQL фильтров, создания/обновления тикетов, Confluence CQL поиска, управления спринтами, MCP server аутентификации."
license: MIT
metadata:
