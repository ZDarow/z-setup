...
description: "Настраивает системы мониторинга, реализует структурированные логи, создаёт Prometheus/Grafana дашборды. Используй для observability, алертинга, distributed tracing, load testing."
license: MIT
metadata:
