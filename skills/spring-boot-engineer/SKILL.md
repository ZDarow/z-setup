...
description: "Генерирует Spring Boot 3.x конфигурации, REST контроллеры, Spring Security 6 аутентификацию. Используй для Spring Data JPA, WebFlux, Spring Cloud, Java REST API."
license: MIT
metadata:
