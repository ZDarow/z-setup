...
description: "Создаёт .NET 8 приложения с minimal APIs, clean architecture, cloud-native микросервисами. Используй для Entity Framework Core, CQRS с MediatR, JWT аутентификации."
license: MIT
metadata:
