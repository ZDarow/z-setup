...
description: "Проектирует GraphQL схемы, реализует Apollo Federation, настраивает real-time подписки. Используй для schema design, resolvers с DataLoader, оптимизации запросов."
license: MIT
metadata:
