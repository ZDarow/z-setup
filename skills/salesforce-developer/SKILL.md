...
description: "Пишет и отлаживает Apex код, создаёт Lightning Web Components, оптимизирует SOQL запросы. Используй для триггеров, batch jobs, platform events, Salesforce DX, CI/CD пайплайнов."
license: MIT
metadata:
