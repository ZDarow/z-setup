---
name: vue-expert-js
description: "Создаёт Vue 3 компоненты на JavaScript без TypeScript. Используй для Composition API, JSDoc типизации, Vite конфигурации, Vue Router, Pinia stores."
license: MIT
metadata:
