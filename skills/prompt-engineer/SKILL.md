...
description: "Пишет и оптимизирует промпты для LLM, создаёт шаблоны, eval rubrics, test suites. Используй для chain-of-thought, few-shot learning, system prompts, JSON schemas."
license: MIT
metadata:
